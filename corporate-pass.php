...
<body class="home page page-id-2">
  ...
  <div id="wrapper" class="home nav-top-mc">
    <section class="contact-w3ls">
      <div class="container">
        <div class="w3_tittle second two"><h3 class="agile-tittle two gal">Corporate Packages</h3> 
          <div class="line-style second"><span class="second"></span></div>
        </div>
      </div>
      <div class="container">
        <p class="text-center text-default text-introduction" style="padding: 0;">Booking 5 delegates or more from your company will save you 10% off the total cost of passes. Fill in the form at the end of this page with your details and our team will be in touch shortly to complete the booking and payment process</p><br/>
        <div class="col-md-12">
          <div class="register-pass">
              ...
              <div class="col-md-8 pass-description">
                <h4 class="color-purple">Platinum Corporate Package</h4>
                <span class="pricely-foreword">5 delegates or more | $4,750 for 5 delegates | 10% overall discount</span>
                <p class="text-introduction" style="font-size: 15px; margin: 0;">
                As a Platinum corporate team, you and your colleagues will experience an elevated networking 
                ...
                <a class="btn pass-reg bg-dark-purple" href="<?=DN?>/register-corporate"><i class="fa fa-long-arrow-right"></i> Get your Platinum package</a>
              </div>
                  ...
                  <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                    <div class="panel-body panel_text">
                      <div class="col-md-6">
                        ...
                        <ul class="summary">
                          <li><i class="fa fa-long-arrow-right"></i>Plenary Sessions including the Opening Ceremony</li>
                      ...
                      <div class="col-md-6">
                        ...
                        <ul class="summary">
                          ...
                          <li><i class="fa fa-long-arrow-right"></i>Dedicated Concierge Service Desk to book meeting rooms</li>
                        </ul>
                      </div>
                      <div class="col-md-12 reg-pass-btn">
                        <a href="<?=DN?>/register-corporate" class="btn">Get your Platinum package</a>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="col-md-12">
          <div class="register-pass">
              ...
              <div class="col-md-8 pass-description">
                ...
                <span class="pricely-foreword">5 delegates or more | $2,475 for 5 delegates | 10% overall discount</span>
                <p class="text-introduction" style="font-size: 15px; margin: 0;">
                As a Gold corporate team, you and your colleagues will have access to all summit sessions as well as 
                networking social events including the cultrual soiree. Gold delegates will also attend the exclusive Gala Dinner joining other gold delegates 
                representing ICT influencers and leading digital thought leaders.</p>
                ...
                <a class="btn pass-reg bg-dark-gold" href="<?=DN?>/register-corporate"><i class="fa fa-long-arrow-right"></i> Get your Gold package</a>
              </div>
              <div class="col-md-12 panel-group panel-mc" id="accordion" role="tablist" aria-multiselectable="true">
                <div class="panel panel-default">
                  <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                    <div class="panel-body panel_text">
                      ...
                      <div class="col-md-12 reg-pass-btn">
                        <a href="<?=DN?>/register-corporate" class="btn">Get your Gold package</a>
                      </div>
                    </div>
                  </div>
                </div>
