...
<body class="home page page-id-2">
  ...
  <div id="wrapper" class="home nav-top-mc">
        <section class="bg-f0">
          <div class="container">
            <div class="row">
                  <div class="w3_tittle second two" style="text-align: center;"><h3 class="agile-tittle two gal reg">Smart Africa Members</h3>
                    <div class="line-style second" style="bottom: -20px;"><span class="second"></span></div>
                  </div>

                  <div class="col-md-12">
                    <p class="text-default text-introduction" style="padding: 0;">Smart Africa Members receive exciting benefits to attend the Transform Africa Summit including a number of complimentary passes & discounts on purchased passes. </p>
                    <p class="text-default text-introduction" style="padding: 0;">Please use form below if you belong to the Smart Africa team in any of the following organisations or if you are part of the official Smart Africa Government representatives team in any of the following member states :</p>
                  </div>
                  ...
                  <div class="members col-md-12">
                    <div class="col-md-6 col-xs-12">
                      <ul>
                        <li>
                          <i class="fa fa-square" aria-hidden="true"></i> Partner Organizations
                          <p><i class="fa fa-long-arrow-right"></i> AU Commission</p>
                          <p><i class="fa fa-long-arrow-right"></i> International Telecommunication Union</p>
                          <p><i class="fa fa-long-arrow-right"></i> African Development Bank (AfDB)</p>
                          <p><i class="fa fa-long-arrow-right"></i> African Telecommunications Union (ATU)</p>
                          <p><i class="fa fa-long-arrow-right"></i> United National Economic Commission for Africa (UNECA)</p>
                          <p><i class="fa fa-long-arrow-right"></i> New Partnership for Africa’s Development (NEPAD)</p>
                          <p><i class="fa fa-long-arrow-right"></i> Internet Coororation for Assgined Names and Numbers (ICANN)
                          <p><i class="fa fa-long-arrow-right"></i> The World Bank</p>
                          <p><i class="fa fa-long-arrow-right"></i> Global System for Mobile Communication (GSM)</p>

                        </li>
                      </ul>
                      <ul>
                          <li>
                            <i class="fa fa-square" aria-hidden="true"></i> Platinum Members 
                            <p><i class="fa fa-long-arrow-right"></i> AU Commission</p>
                            <p><i class="fa fa-long-arrow-right"></i> Inmarsat </p>
                            <p><i class="fa fa-long-arrow-right"></i> Ericsson </p>
                            <p><i class="fa fa-long-arrow-right"></i> Liquid Telecom </p>
                            <p><i class="fa fa-long-arrow-right"></i> Econet Wireless </p>
                            <p><i class="fa fa-long-arrow-right"></i> Huawei</p>
                          </li>
                      </ul>
                      <ul>
                        <li style="margin: 0 0 0.5em">
                          <i class="fa fa-square" aria-hidden="true"></i> Gold members 
                          <p><i class="fa fa-long-arrow-right"></i> Intel</p>
                          <p><i class="fa fa-long-arrow-right"></i> Global Voice Group S.A </p>
                          <p><i class="fa fa-long-arrow-right"></i> Microsoft  </p>
                          <p><i class="fa fa-long-arrow-right"></i> Orange  </p>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div class="col-md-6 col-xs-12">
                      <ul>
                        <li style="margin: 0 0 0.5em">
                          <i class="fa fa-square" aria-hidden="true"></i> Silver members 
                          <p><i class="fa fa-long-arrow-right"></i>Vanu</p>
                          <p><i class="fa fa-long-arrow-right"></i>Sparkle</p>
                          <p><i class="fa fa-long-arrow-right"></i>Culligan</p>
                          <p><i class="fa fa-long-arrow-right"></i>Arabsat</p>
                        </li>
                      </ul>
                      <ul>
                        <li style="margin: 0 0 0.5em">
                          <i class="fa fa-square" aria-hidden="true"></i> Entrepreneurs and Start ups
                          <p><i class="fa fa-long-arrow-right"></i>Afritek IT</p>
                          <p><i class="fa fa-long-arrow-right"></i>Cyberlibris</p>
                          <p><i class="fa fa-long-arrow-right"></i>Unchartered Play Inc</p>
                          <p><i class="fa fa-long-arrow-right"></i>Gebeya Limited</p>
                          <p><i class="fa fa-long-arrow-right"></i>ANSUT</p>
                          <p><i class="fa fa-long-arrow-right"></i>Groupe Defis et Strategis</p>
                          <p><i class="fa fa-long-arrow-right"></i>SCHOOLOS.EU</p>
                          <p><i class="fa fa-long-arrow-right"></i>United Kingdom Telecommunication Academy</p>
                          <p><i class="fa fa-long-arrow-right"></i>United States Telecommunications Training Institute</p>
                          <p><i class="fa fa-long-arrow-right"></i>Carnegie Mellon University</p>
                          <p><i class="fa fa-long-arrow-right"></i>Ecole Supérieure Multinationale des Télécommunications</p>
                        </li>
                      </ul>
                      <!-- <ul>
                        <li>
                          <i class="fa fa-square" aria-hidden="true"></i> Member States
                          <p><i class="fa fa-long-arrow-right"></i> Angola</p>
                          <p><i class="fa fa-long-arrow-right"></i> Benin</p>
                          <p><i class="fa fa-long-arrow-right"></i> Burkina Faso</p>
                          <p><i class="fa fa-long-arrow-right"></i> Cameroon</p>
                          <p><i class="fa fa-long-arrow-right"></i> Chad </p>
                          <p><i class="fa fa-long-arrow-right"></i> Côte d'Ivoire</p>
                          <p><i class="fa fa-long-arrow-right"></i> Djibouti</p>
                          <p><i class="fa fa-long-arrow-right"></i> Egypt</p>
                          <p><i class="fa fa-long-arrow-right"></i> Gabon</p>
                          <p><i class="fa fa-long-arrow-right"></i> Guinea</p>
                          <p><i class="fa fa-long-arrow-right"></i> Kenya</p>
                          <p><i class="fa fa-long-arrow-right"></i> Mali</p>
                          <p><i class="fa fa-long-arrow-right"></i> Niger</p>
                          <p><i class="fa fa-long-arrow-right"></i> Rwanda</p>
                          <p><i class="fa fa-long-arrow-right"></i> São Tomè and Principe</p>
                          <p><i class="fa fa-long-arrow-right"></i> Senegal</p>
                          <p><i class="fa fa-long-arrow-right"></i> South Africa</p>
                          <p><i class="fa fa-long-arrow-right"></i> South Sudan</p>
                          <p><i class="fa fa-long-arrow-right"></i> Togo</p>
                          <p><i class="fa fa-long-arrow-right"></i> Tunisia</p>
                          <p><i class="fa fa-long-arrow-right"></i> Uganda</p>
                        </li>
                      </ul> -->
                    </div>
                  </div>
                  ...
                  <div class="col-md-12">
                    <p class="text-default text-introduction" style="padding: 0; margin: 10px 0;">The Smart Africa Team will be in touch with you and follow Smart Africa Members protocol to complete the process.</p>
                  </div>  
              ...
              <div class="col-md-12">
                ...
                <div class="content-form-page" style="margin: 0px;">
                  <form role="form" method="post" id="reg-form" class="form-horizontal form-without-legend" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <input type="hidden" name="register-type" value="Smart Africa Members">
