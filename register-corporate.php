...
if(Input::checkInput('webToken','post','1') && Input::checkInput('request','post','1')){
  ...
  switch($task){
    ...
    // API NEW PARTICIPANT
    case 'register-new':
      $form = CorporateController::add('API');
      break;
  }
}
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <div class="content-form-page" style="margin-bottom: 30px;">
                  <div class="w3_tittle second two" style="text-align: center;"><h3 class="agile-tittle two gal reg">Corporate Package Request Form</h3>
                  ...
                  <form role="form" method="post" id="reg-form" class="form-horizontal form-without-legend" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <label class="col-md-2 control-label">Gold Passes</label>
                      <div class="col-md-8">
                        <select class="form-control" name="register-gold">
                          <?php for ($i = 4; $i <= 50; $i++) : 
                            if ($i == 4) {
                          ?>
                            <option value="select">[--Please select number of gold passes required--]</option>
                    ...
                    <div class="form-group">
                      <label class="col-md-2 control-label">Platinum Passes</label>
                      <div class="col-md-8">
                        <select class="form-control" name="register-platinum">
                          <?php for ($i = 4; $i <= 50; $i++) : 
                            if ($i == 4) {
                          ?>
                            <option value="select">[--Please select number of platinum passes required--]</option>
