...
<div class="panel panel-reg" >
    <form method="post" id="reg-form" class="form-horizontal" enctype="multipart/form-data">
        ...
        <div class="reg-header" style="background: #fff; border-bottom: 1px solid #ddd; padding: 15px 30px;">
            <h2 style="font-size: 18px; color:#000;">Group Registration Invite</h2>
        </div>
        ...
        <div class="panel-body" style="padding: 30px 30px 15px 30px;">
            ...
            <?php }else{?>
                ...
                <p>Welcome to your Transform Africa Summit group booking portal designed to make it easier for your group to register and attend Africa's largest ICT summit.<br><br>
                <b style="color: red;">Important information:</b><br>
                
                •   Invite your group members below by filling in their first name, last name & email address in the appropriate pass type and then press send.<br>
                •   Ensure you only do one at a time i.e. press send after every name you fill in.<br>
                •   An email will be sent to the individual you have invited to complete their registration.<br>
                •   Please note that the "<b>Status</b>" column will appear as '<b>Pending</b>' after they are invited whilst registration is processed.<br>
                •   Once confirmed, the "<b>Status</b>" column will read '<b>Confirmed</b>'<br>
                •   You can also send a reminder to the person you have invited if you log in and see that their status is still '<b>Pending</b>'. This can be done by clicking on the '<b>Reminder</b>' button.<br>
                •   Remember to register yourself by sending an invite to your email address through the same system.
                </p>
                ...
                <!-- <p>
                    ...
                    •   A new group account can be created for you for additional registrations by sending an email to enquiries@youthconnektafrica.org.<br>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-condensed no-margin" style="margin-bottom: 65px">
                            <thead class="tb_head">
                                <tr>
                                    <th><span style="color:#000;">ID</span></th>
                                    <th><span style="color:#000;">Pass type</span></th>
                                    <th><span style="color:#000;">Status</span></th>
                                    <th><span style="color:#000;">First name</span></th>
                                    <th><span style="color:#000;">Last name</span></th>
                                    <th><span style="color:#000;">Email</span></th>
                                    <th>Payment</th>
                                    <th><span style="color:#000;">Status</span></th>
                                    <th><span style="color:#000;">Action</span></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php 
                                                ...
                                                <td colspan="4">
                                                    <div class="btn-group pull-right">
                                                        ...
                                                        <ul class="dropdown-menu" style="padding: 10px 10px; border-radius: 0px">
                                                            ...
                                                            <li>Bank transfer</li>
                                                            <li><a href="<?=DN?>/banktransfer-rwf/group/<?=$session_subscriber_data->ID?>">Pay in RWF</a></li>
                                                            <li><a href="<?=DN?>/banktransfer-usd/group/<?=$session_subscriber_data->ID?>">Pay in USD</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
