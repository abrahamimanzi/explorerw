                            ...
                            <div class="form-group">
                              <div class="col-sm-12">
                                  ...
                                  <p class="fieldset-header text-center" style="line-height: 25px; font-size: 15px">
                                      <span class="ro_bold" style="font-size: 15px"><?=$participant_data->firstname.' '.$participant_data->lastname?></span>, thank you for your interest in <span class="ro_bold">Transform Africa Summit 2018</span>. <br>Your registration is now being processed.<br>
