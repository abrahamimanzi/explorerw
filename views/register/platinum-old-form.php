                    ...
                    <div class="panel panel-reg" >
                        ...
                        <?php if($form->ERRORS && (@$form->ERRORS_SCRIPT['email'][0] == 'NOTUNIQUE' || @$form->ERRORS_SCRIPT['document_number'][0] == 'NOTUNIQUE')){
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-9">
                                  <select name="register-golf" id="golf" class="form-control bordered" required="required">
...
-->
                            ...
                            <div class="form-group" >
                                <span style="display:none;">
                                <?php if(($_invitation_source && $subscateg_data->plan=='Free') OR ($passtype_complimentary =='Complimentary')){?>
                                </span>
