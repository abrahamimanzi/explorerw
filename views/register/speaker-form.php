            ...
            <div class="col-sm-8">
                    <div class="panel panel-reg" >
                        ...
                        <div class="reg-header" style="">
                            <h2 class="text-center reg-title" style="font-size: 20px; color: #fff">Apply to Speak at TAS17</h2>
                        </div>
                        ...
                        <?php if($form->ERRORS && (@$form->ERRORS_SCRIPT['email'][0] == 'NOTUNIQUE' || @$form->ERRORS_SCRIPT['document_number'][0] == 'NOTUNIQUE')){
                            ...
                            <div class="form-group">
                                ...
                                <label class="control-label col-sm-12">
                                    <div class="">
                                    Kindly note, it is not a registration for a pass. It  is an application is to register your interest to speak at the Transform Africa Summit 2017.
                                    </div>
                                </label>
                            </div>
                              ...
                              <div class="col-sm-9">
                                <select name="register-title" id="title" class="form-control bordered" required="required">
                                   <option value="" <?php if($form->ERRORS && Input::get('register-title','post') == ''){ echo 'selected="selected"';}?>>[--Select--]</option>
                                    <?php
                                      $array = array("H.E.","Hon.","Prof.","Dr.","Mr.","Mrs.","Ms.","Military")
                                      ?> 
                                    <?php 
...
-->
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-9">
                                  <div class="row">
                                      <div class="col-sm-12">
                                          <textarea name="register-special_request" type="text" rows="3" cols="10" class="form-control" id="special_request" maxlength="500" placeholder="Proposal Summary" required="required"><?php if($form->ERRORS && Input::get('register-special_request','post')){ echo Input::get('register-special_request','post'); }?></textarea>
                                      </div>
                                  </div>
                              </div>
                            </div>
...
//        preferredCountries: [ "rw","ug","ke","ga","td","ss","sn","ml","ci","bf","ao","dj","gn","bj"],
        preferredCountries: [ ''],
