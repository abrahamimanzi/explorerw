                              ...
                              <div class="col-sm-12">
                                  ...
                                  <p class="fieldset-header text-center" style="line-height: 25px; font-size: 15px">
                                    ...
                                    if($transaction['message'] == 'Cancelled'){ ?>
                                          ...
                                          <span class="ro_bold" style="font-size: 15px"><?=$participant_data->firstname.' '.$participant_data->lastname?></span>, thank you for your interest in <span class="ro_bold">Transform Africa Summit 2018</span>. <br>You seem to entered an incorrect card details, please try again.<br>
                                          <?php 
                                            switch($participant_data->category){
                                                case 'Government':
                                                    echo '';
