                              ...
                              <div class="col-sm-12">
                                  ...
                                  <p class="fieldset-header text-center" style="line-height: 25px; font-size: 15px">
                                    ...
                                    <!-- if(@$_GET['process'] == 'success' && $participant_data->payment_state == "Confirmed"){ ?> -->
                                          ...
                                          </span>, thank you for your registration to the Transform Africa Summit 2018. <br> The transaction was completed successfully. Your payment confirmation and receipt will be sent to 
                                          <span class="ro_bold">
                                          ...
                                          <span class="ro_bold" style="font-size: 15px"><?=$participant_data->firstname.' '.$participant_data->lastname?></span>, thank you for your registration to the <span class="ro_bold">Transform Africa Summit 2018</span>. <br>Your registration is now being processed.<br>
                                          <?php 
