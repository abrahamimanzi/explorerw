 ...
 <?php 
    ...
    if($participantTable->count()){
        ...
        <div class="text-center" style="background: #fff; padding: 15px 20px 15px 20px;">
            ...
            you seem to have already registered for a pass for Transform Africa Summit 2018.

                To upgrade your pass or get more information about your registration, contact us at  <span style="font-family: 'Roboto-Bold'; font-size: 15px">enquiries@smartafrica.org</span><br>
                <br>
                <hr>
                <a href="<?=DN?>" class="btn btn-default btn-sm"><i class="fa fa-angle-double-left"></i> Back</a>
            </p>
        </div>
    <?php }?>