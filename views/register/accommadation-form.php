            ...
            <div class="col-sm-8">
                    <div class="panel panel-reg" >
                        ...
                        <div class="reg-header" style="">
                                <h2 class="text-center reg-title" style="font-size: 20px; color: #fff"> TAS2017 HOTEL <?=$passtype?></h2>
                        </div>
                        ...
                        <?php if($form->ERRORS && (@$form->ERRORS_SCRIPT['email'][0] == 'NOTUNIQUE' || @$form->ERRORS_SCRIPT['document_number'][0] == 'NOTUNIQUE')){
                            ...
                            <?php }?>    
                            <label class="control-label" style="padding-top:20px">Our accommodation team will help you book your accommodation for this particular hotel. Please fill in the form below and we will be in touch shortly.</label>
                            <label class="control-label" style="padding-top:20px"> All <span class="req" style="font-size: 16px;">*</span> fields are mandatory  </label>
                             
                            <br> 
                            
                             <div class="form-group">
                              <div class="col-sm-12"><?php $hotel = Input::get('passtype','get'); ?>
                                    ...
                                    <span class="pull-right text-uppercase text-success">
                                      ...
                                      <?php
                                        switch ($hotel) {
                                          case 'hilltop':
                                            echo "Hill top hotel";
                                            $hotel = 'Hill top hotel';
                                            break;
                                          
                                          case 'orient':
                                            echo "Orient Park Hotel";
                                            $hotel = 'Orient Park Hotel';
                                            break;
                                          
                                          case 'garr':
                                            echo "GARR HOTEL KIGALI";
                                            $hotel = 'Garr hotel Kigali';
                                            break;
                                          
                                          case 'lando':
                                            echo "CHEZ LANDO HOTEL";
                                            $hotel = 'Chez Lando hotel';
                                            break;
                                          
                                          case 'gorillas':
                                            echo "GORILLAS CITY CENTRE";
                                            $hotel = 'Gorillas city centre';
                                            break;
                                          ...
                                          case 'karisimbi':
                                            echo "Karisimbi Hotel";
                                            $hotel = 'Karisimbi Hotel';
                                            break;

                                          case 'portofino':
                                            echo "Hotel Villa Portofino";
                                            $hotel = 'Hotel Villa Portofino';
                                            break;
                                          
                                          case 'legend':
                                            echo "LEGEND HOTEL KIGALI";
                                            $hotel = 'Legend Hotel Kigali';
                                            break;
                                          
                                          case 't2000':
                                            echo "T2000 HOTEL KIGALI";
                                            $hotel = 'T2000 Hotel Kigali';
                                            break;
                                          
                                          case 'mirror':
                                            echo "THE MIRROR HOTEL";
                                            $hotel = 'The mirror Hotel';
                                            break;
                                          
                                          case 'ubumwe':
                                            echo "Ubumwe Grand Hotel";
                                            $hotel = 'Ubumwe Grand Hotel';
                                            break;
                                          
                                          case 'legacy':
                                            echo "Grand Legacy Hotel";
                                            $hotel = 'Grand Legacy Hotel';
                                            break;
                                          ...
                                          case 'golf':
                                            echo "Gorillas Golf Hotel";
                                            $hotel = 'Gorillas Golf Hotel';
                                            break;
...
-->
                            ...
                            <div class="form-group">
                                <br>
                                <input type="hidden" name="register-hotel" value="<?=$hotel?>">
