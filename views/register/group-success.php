                              ...
                              <div class="col-sm-12">
                                  ...
                                  <p class="fieldset-header text-center" style="line-height: 25px; font-size: 15px">
                                    ...
                                    if($transaction['message'] == 'Cancelled'){ ?>
                                          ...
                                          <span class="ro_bold" style="font-size: 15px"><?=$participant_data->firstname.' '.$participant_data->lastname?></span>, thank you for your interest in <?=$participate_in?><span class="ro_bold"> Transform Africa Summit 2018 edition</span>. 
                            ...
                            <div class="form-group">
                              <div class="col-sm-12">
                                  ...
                                  <p class="fieldset-header text-center" style="line-height: 25px; font-size: 15px">
                                          ...
                                          <span class="ro_bold" style="font-size: 15px"> </span>Thank you for submitting your group registration application for Transform Africa Summit<br> (Kigali, Rwanda, 7 - 10 May 2018).<br>
