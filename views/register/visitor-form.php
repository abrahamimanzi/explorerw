...
<section class="reg-body open bg5 bg-img-orange">
                <br>
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-8">
                    <div class="panel panel-reg" >
                        ...
                        <div class="reg-header" style="">
                                <h2 class="text-center reg-title" style="font-size: 20px; color: #fff"><?=$passtype?> Pass Request</h2>
                        </div>
                        ...
                        <?php if($form->ERRORS && (@$form->ERRORS_SCRIPT['email'][0] == 'NOTUNIQUE' || @$form->ERRORS_SCRIPT['document_number'][0] == 'NOTUNIQUE')){
                            ...
                            <div class="form-group">
                                ...
                                <label class="control-label col-sm-12">
                                    ...
                                    Free exhibition passes are available to specific segments including students, academics, ICT related incubation hub tenants amongst others. Fill in the form below to apply. Passes are given at the organisers discretion and are dependent on availability.
                                    </div>
                                </label>
                            </div>
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-3" for="jobtitle">Job title
                                <span  class="req">*</span> 
