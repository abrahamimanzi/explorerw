            ...
            <div class="col-sm-8">
                    <div class="panel panel-reg" >
                        ...
                        <div class="reg-header" style="">
                                <h2 class="text-center reg-title" style="font-size: 20px; color: #fff">Government Officials invite application</h2>
                        </div>
                        ...
                        <?php if($form->ERRORS && (@$form->ERRORS_SCRIPT['email'][0] == 'NOTUNIQUE' || @$form->ERRORS_SCRIPT['document_number'][0] == 'NOTUNIQUE')){
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="register-company" id="company" placeholder="Enter Organization Name"
                                      ...
                                      <div class="row">
                                        <div class="col-sm-6">
                                            <select name="register-orgcategory" id="orgcategory" class="form-control bordered" onchange="Checkother1(this,'#orgcategory1');" required="required">
                                                ...
                                                <option value="Parastatal" <?php if($form->ERRORS && Input::get('register-orgcategory','post') == 'Parastatal'){ echo 'selected="selected"';}?>>Parastatal</option>
                                                <option value="Public Administration" <?php if($form->ERRORS && Input::get('register-orgcategory','post') == 'Public Administration'){ echo 'selected="selected"';}?>>Public Administration</option>
                                                <option value="Statutory Authority" <?php if($form->ERRORS && Input::get('register-orgcategory','post') == 'Statutory Authority'){ echo 'selected="selected"';}?>>Statutory Authority</option>
                                                <option value="Regulatory Agency" <?php if($form->ERRORS && Input::get('register-orgcategory','post') == 'Regulatory Agency'){ echo 'selected="selected"';}?>>Regulatory Agency</option>
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-3" for="industry">Sector
                                <span  class="req">*</span> 
                                  ...
                                  <div class="row">
                                      <div class="col-sm-6">
                                          <select name="register-industry" id="industry" class="form-control bordered" onchange="Checkother1(this,'#industry1');" required="required">
                                            ...
                                            <?php
                                              $array = array("Communication &amp; Media","ICT","Transportation.","Infrastructure","Energy &amp; Water Or Sanitation","Education","Health","Justice","Labour and social security","Urbanisation","Civil aviation","Economy and Finance","Environment","Foreign Affairs","Agriculture","Trade &amp; Industry","Defense","Sports, Art and Culture","Tourism","Youth and Gender","Natural Resources","Disaster Management","Public Service","Security","Other");
                                              ?><?php 
                                                for($i=0;$i<count($array);$i++){?>
                                                    <option value="<?=$array[$i];?>" <?php if($form->ERRORS && Input::get('register-industry','post') == $array[$i]){ echo 'selected="selected"'; }?>><?=$array[$i];?> </option>
                                                <?php
                                                } 
                                            ?>
                                        </select>
