        ...
        <div class="row">
            <div class="col-sm-4" style="padding: 5px">
                <div style="padding: 0px 5px;">
                    ...
                    <div class="image-size-label">
                        Photograph requirements <span style="color: red;" class="req">*</span>
                    </div>
                    <br>
                    <ul>
                        ...
                        <li>Maximum size: 250 Kb</li>
                        <li>Format: jpg file</li>
                        <li>No hats, sunglasses, dark glasses, headphones,  wireless hands-free devices or similar items, jewellery or garments of any sort that obstruct the view of the face, <br><span class="ro_bold" data-toggle="modal" data-target="#photoSpecModal_1" style="cursor: pointer">View More</span></li>
                    </ul>
                    <?php }?>
                </div>
            </div>
            <div class="col-sm-4" style="padding: 5px">
                <div class="form-group">
                    <input name="register-photo" onchange="readURL(this);" type="file" required="required"/>
                </div>
            </div>
            <div class="col-sm-4" style="padding: 5px">
