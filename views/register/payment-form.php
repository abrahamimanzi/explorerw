      ...
      <!--                                  <span class="close pull-left"><a href="<?=DN?>/register" class="btn btn-default"><i class="glyphicon glyphicon-remove"></i> Cancel</a></span>-->
                              ...
                              <?php }else{?>
                                  <div class="form-group">
                                    <div class="col-sm-12">
                                        <br>
                                        <p class=" text-center"><span class="ro_bold"><?php echo $participant_data->firstname;?> </span>, Thank you for your interest in Transform Africa Summit 2018. Your registration is now being processed.
                                          <br>
...
?>
<form method="post" class="form-horizontal" id="pay-form" autocomplete="nope">
  <section class="reg-body open bg1  bg-img-orange">
                  <br>
                  <br>
      <div class="container">
          <div class="row">
              ...
              <div class="col-sm-8">
                      <div class="panel panel-reg" style="background: #fff;">
                          <div class="reg-header">
                              ...
                              <?php if($_group_owner){ ?>
                              <h2 class="text-center reg-title" style="text-transform: capitalize">Step one completed. Awaiting Payment</h2>

                              <?php }elseif(!$_bank_transfer){ ?>
                              <h2 class="text-center reg-title" style="text-transform: capitalize">Step one completed. Continue to pay</h2>
                              <?php }else{ ?>
                              <h2 class="text-center reg-title" style="text-transform: capitalize">Step one completed. Payment details are below</h2>
                              <?php } ?>
                          </div>
