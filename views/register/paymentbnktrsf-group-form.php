            ...
            <div class="col-sm-10">
                    <div class="panel panel-reg" style="background: #fff;">
                        <div class="reg-header">
                            <h2 class="text-center reg-title" style="text-transform: uppercase;"><i class="fa fa-angle-double-right"></i> Group Payment details</h2>
                        </div>
            ...
            <tr>
                ...
                <td>
                  <?php
                    ...
                    echo $subscriber_code;
                  ?>
                </td>
            </tr>
            <tr>
                <td>Payment amount</td>
                <td><?=$currency_str.' '.$net_total?></td>
            </tr>
            <tr>
                <td>Account Name</td>
                ...
                <td>Bank of Kigali, Headquarters,<br> KN 4 Ave, Kigali – Rwanda</td>
                            ...
                            <div class="form-group">
                              <div class="col-sm-12">
                                  <br>
                                  <p class=" text-center">
                                    <span class="ro_bold"><?php echo $session_subscriber_data->firstname;?> <?php echo $session_subscriber_data->lastname;?></span>, 
                                    please do not forget to <span style="font-family: 'Roboto-Bold', sans-serif;">use your Group ID as the payment reference as it is used to identify your payment</span>.
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-12 text-center">
                                  <br>
                                  <?php
                                    $currency_str = strtolower($currency_str);
                                  ?>
                                  <a href="<?=DN?>/print-<?=$currency_str?>/group/<?=$_id?>" style="color: #888" type="submit" class="submit_btn btn orange-bg btn-default btn-md"><i class="glyphicon glyphicon-print"></i> Save or print</a>
