                        ...
                        <div class="reg-header">
                            ...
                            <?php
                                ...
                                if ($process == 'registered') {
                                  ...
                                  echo 'member REGISTRATION Request';
                                } else{
                            ...
                            <div class="form-group">
                              <div class="col-sm-12">
                                  ...
                                  <p class="fieldset-header text-center" style="line-height: 25px; font-size: 15px">
                                          ...
                                          <span class="ro_bold" style="font-size: 15px"> </span>Thank you for submitting your registration request for Transform Africa Summit<br> (Kigali, Rwanda, 7 - 10 May 2018).<br>
