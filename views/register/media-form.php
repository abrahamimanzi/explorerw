...
<section class="reg-body open bg-img-green">
                <br>
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-8">
                    <div class="panel panel-reg" >
                        ...
                        <div class="reg-header" style="">
                            <h2 class="text-center reg-title" style="font-size: 20px; color: #fff">Media pass application</h2>
                        </div>
                        ...
                        <?php if($form->ERRORS && (@$form->ERRORS_SCRIPT['email'][0] == 'NOTUNIQUE' || @$form->ERRORS_SCRIPT['document_number'][0] == 'NOTUNIQUE')){
                            ...
                            <div class="form-group">
                            <label class="control-label col-sm-3" for="company">Media house
                                <span  class="req">*</span> 
                                <span style="color: red; font-size: 12px; display: block"> <?php if($form->ERRORS){ echo @$form->ERRORS_SCRIPT['company'][0];}?> </span>
                            </label>
                              <div class="col-sm-9">
                                <input type="text" class="form-control" name="register-company" id="company" placeholder="Enter Media House"
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="orgcategory">Media category
                                    <span  class="req">*</span> 
                                      ...
                                      <div class="row">
                                        <div class="col-sm-6">
                                            <select name="register-orgcategory" id="orgcategory" class="form-control bordered" onchange="Checkother1(this,'#orgcategory1');" required="required">
                                                ...
                                                <option value="Bloggers" <?php if($form->ERRORS && Input::get('register-orgcategory','post') == 'Bloggers'){ echo 'selected="selected"';}?>>Bloggers</option>

                                                <option value="Freelancer" <?php if($form->ERRORS && Input::get('register-orgcategory','post') == 'Freelancer'){ echo 'selected="selected"';}?>>Freelancer</option>

                                                <option value="Private" <?php if($form->ERRORS && Input::get('register-orgcategory','post') == 'Private'){ echo 'selected="selected"';}?>>Private</option>

                                                <option value="State-owned Media" <?php if($form->ERRORS && Input::get('register-orgcategory','post') == 'State-owned Media'){ echo 'selected="selected"';}?>>State-owned Media</option>
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-3" for="jobtitle">Position
                                <span  class="req">*</span> 
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="pressCard">Press card Number 
                                    <span style="color: red; font-size: 12px; display: block"> <?php if($form->ERRORS){ echo @$form->ERRORS_SCRIPT['media_card'][0];}?> </span>
                                </label>
                              <div class="col-sm-9">
                                <input type="text" class="form-control" name="register-media_card" id="pressCard" placeholder="Enter Press Card Number" 
                                       <?php if($form->ERRORS && Input::get('register-media_card','post')){?> value="<?php echo Input::get('register-media_card','post');?>" <?php }?> maxlength="15">
                              </div>
                            </div>  
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="issuingAuthority">Issuing authority
                                    <span style="color: red; font-size: 12px; display: block"> <?php if($form->ERRORS){ echo @$form->ERRORS_SCRIPT['media_card_authority'][0];}?> </span>
                                </label>
                              <div class="col-sm-9">
                                <input type="text" class="form-control" name="register-media_card_authority" id="issuingAuthority" placeholder="Enter Issuing Authority" 
                                       <?php if($form->ERRORS && Input::get('register-media_card_authority','post')){?> value="<?php echo Input::get('register-media_card_authority','post');?>" <?php }?> maxlength="50">
                              </div>
                            </div>   
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="dateOfExpiry">Date of expiry
                                    <span style="color: red; font-size: 12px; display: block"> <?php if($form->ERRORS){ echo @$form->ERRORS_SCRIPT['media_card_expiry'][0];}?> </span>
                                </label>
                              <div class="col-sm-9">
                                  <!-- <div class="input-group"> -->
                                  <div class="">
                                      <!-- <label class="input-group-addon" for="dateOfExpiry">
                                        <i class="fa fa-calendar"></i>
                                      </label> -->
                                      <input type="text" class="datemask form-control" name="register-media_card_expiry" id="dateOfExpiry" placeholder="dd/mm/yyyy"
                                       <?php if($form->ERRORS && Input::get('register-media_card_expiry','post')){?> value="<?php echo Input::get('register-media_card_expiry','post');?>" <?php }?> data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="">
                                    </div>
                              </div>
                            </div>   
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-3" for="document_type"  style="padding-right: 5px">Upload photo
                                <span  class="req">*</span> 
                              </label>
                              <!-- <div class="col-sm-12">
...
-->
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="special_request">Special request <small>(Up to 1000 characters)</small> 
                                  <span style="color: red; font-size: 12px; display: block"> <?php if($form->ERRORS){ echo @$form->ERRORS_SCRIPT['special_request'][0];}?> </span>
                                </label>
                              <div class="col-sm-9">
                                  <div class="row">
                                      <div class="col-sm-12">
                                          <textarea name="register-special_request" type="text" rows="3" cols="10" class="form-control" id="special_request" maxlength="1000" placeholder="<?php if($categ == "Media"){ echo 'eg. Sessions cover,...';}?> <?php if($categ == "Speaker"){ echo 'Proposal Summary';}?>"><?php if($form->ERRORS && Input::get('register-special_request','post')){ echo Input::get('register-special_request','post'); }?></textarea>
                                      </div>
                                  </div>
                              </div>
                            </div>
                                ...
                                <div class="form-group">
                                  <div class="col-sm-12">
                                      <h4 class="fieldset-header">TOOLS <span class="req"></span></h4>
                                     <hr class="halfLine">
                                  </div>
                                </div>
                                <div class="form-group">
                                  <label class="control-label col-sm-3" for="media_equipment">
                                      List of equipment to be brought:
                                        <span  class="req">*</span>
                                      <span style="color: red; font-size: 12px; display: block"> <?php if($form->ERRORS){ echo @$form->ERRORS_SCRIPT['media_equipment'][0];}?> </span>
                                    </label>
                                  <div class="col-sm-9">
                                    <textarea name="register-media_equipment" type="text" rows="3" cols="10" class="form-control" id="media_equipment" maxlength="1000" required placeholder="Eg: Camera; Microphone ..."><?php if($form->ERRORS && Input::get('register-media_equipment','post')){ echo Input::get('register-media_equipment','post'); }?></textarea>
                                  </div>
                                </div>
                            ...
                            <div class="form-group">
                                <hr class="halfLine">
                                <label class="control-label col-sm-12" style="color: #000; font-weight: 600; font-size: 13px; font-family: "Gotham Medium", sans-serif;">Thank you. Kindly check over the information you have provided above to ensure it is correct. </label><br>
                                <label class="control-label" style="display: inline-block; cursor: pointer;color: #000; font-weight: 600; font-size: 13px; padding-left: 15px; font-family: "Gotham Medium", sans-serif;" for="check" >
<!--
