...
<head>  
    ...
    <title>Privacy Policy | Transform Africa Summit</title>	 
            ...
            <div class="container white-bg">
                ...
                <div class="register_layout" id="other" >
		             ...
		             <ol class="actions actions1">
		                 ...
		                 <li class="text-default" style="margin-bottom: 10px;">Substitutions with employees from your organisation or any other personnel are not possible.</li>

		                 <li class="text-default" style="margin-bottom: 10px;">You may not purchase registrations as an agent for any third party or sell or otherwise transfer your registration to others, or exploit the registration commercially or non-commercially in any way.</li>

		                 <li class="text-default" style="margin-bottom: 10px;">Organisation may (at its sole discretion) change the format, speakers, participants, content, venue location and programme or any other aspect of the Conference at any time and for any reason, whether or not due to a Force Majeure Event, in each case without liability.</li>
		                 ...
		                 <li class="text-default" style="margin-bottom: 10px;">Where a Force Majeure Event has or may have (in Organisation's sole discretion) an adverse impact on:
		                 	<ol class="actions actions1">
						...
						If the Organisation is liable to you for any reason, the Organisation's total liability to you in relation to the Conference (whether under these terms or conditions or otherwise) is limited to the amount of your fees received by the Organisation.
		                 ...
		                 <li class="text-default" style="margin-bottom: 10px;">Then such delay or non-performance shall not be deemed to be a breach of this Agreement and no loss or damage shall be claimed by you by reason thereof. The Organisation's obligations shall be suspended during the period of the delay or non-performance and the Organisation and you shall each use reasonable endeavours to mitigate the effect of the Force Majeure Event. The provisions of this Condition 16 are subject to the provision of Condition 10</li>

		                 <li class="text-default" style="margin-bottom: 10px;">The Organisation reserves the right to amend these terms and conditions from time to time. However, you will be subject to the terms and conditions in force at the time you submit your registration.</li>

		                 <li class="text-default" style="margin-bottom: 10px;">No person other than you and the Organisation shall have the right to enforce these terms and conditions between us without the prior written agreement of you and Organisation.</li>

		                 <li class="text-default" style="margin-bottom: 10px;">This Agreement is governed by laws of the Republic of Rwanda and you submit to the exclusive jurisdiction of the Rwandan courts. Nothing in this Condition 19 shall prevent or restrict Organisation from pursuing any action against you in any court of competent jurisdiction.</li>
		            </ol>
                </div>
            </div>
            <br>
