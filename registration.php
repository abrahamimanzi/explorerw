    ...
    if($shared_string){
        ...
        if($subscategInviteTable->count()){
            ...
            if($subscateginvite_data->hash == $hash_string){
                if ($subscriber_ID==0) {
                    $category_ID = $subscateginvite_data->subscateg_ID;
                }else{
                ...
                switch ($passtype) {
                    ...
                    case 'Government-Silver-Complimentary':
                        $passtype = 'Silver';
                        $passtype_complimentary = 'Complimentary';
                        break;
	...
	switch($task){
		...
		case 'register-new':
            if(Input::checkInput('register-event_token','post','1')){
                ...
                // if($event_select->first()->token == $event_token){
                    ...
                    switch($categ){
                        ...
                        case 'Bbcom-gold-complimentary':
                            ...
                            break;
                        case 'Delegate':
                            $form = DelegatController::add('API');
                            break;
                        case 'Platinum':
                        ...
                        case 'Diplomatic-Mission-Platinum-Complimentary':
                        case 'Bbcom-platinum-complimentary':
                            $form = PlatinumController::add('API');
                            break;
                        case 'Delegateinvitee':
                            $form = DelegateinviteeController::add('API');
                            break;
                        case 'Exhibitor':
                        ...
                        case 'Government':
                            ...
                            break;
                        case 'Governmentinvitee':
                            $form = GovernmentinviteeController::add('API');
                            break;
                        case 'Specialcase':
                            $form = GovernmentinviteeController::add('API');
                            break;
...
<head>  
    ...
    <?php include 'includes/head-common-r.php';?>
    <link rel="stylesheet" href="<?=DN?>/css/style.css">
    <title>Transform Africa Summit</title>	 
...
<body>
        ...
        <section class="section-main " style="border-bottom: 1px solid #ddd; padding-bottom: 30px; background: rgba(180, 193, 224, 0.04">
            ...
            <?php
                switch($categ){
                    ...
                    case 'Ms-Geek-Platinum-Complimentary':
                    case 'Bbcom-platinum-complimentary':
                        include 'views/register/platinum-form.php';
                        break;
                    case 'Delegate':
                        include 'views/register/delegat-form.php';
                        break;
                    case 'Delegateinvitee':
                        include 'views/register/delegateinvitee-form.php';
                        break;
                    case 'Media':
                    ...
                    case 'Government':
                        ...
                        break;
                    case 'Governmentinvitee':
                        include 'views/register/governmentinvitee-form.php';
                        break;
                    case 'Specialcase':
                        include 'views/register/governmentinvitee-form.php';
                        break;
  ...
  <script type="<?=DN;?>/text/javascript">
      jQuery(document).ready(function() {
          Layout.init();    
          Layout.initOWL();
          Layout.initImageZoom();
