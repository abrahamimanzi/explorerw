...
if($url_struc['branch-sub2'] =='exportsilver'){
    
    $event_ID = Input::get('id','get');
    Redirect::to(DNADMIN.'/exportsilver/');
}
if($url_struc['branch-sub2'] =='exportgold'){
    
    $event_ID = Input::get('id','get');
    Redirect::to(DNADMIN.'/exportgold/');
}
if($url_struc['branch-sub2'] =='exportplatinum'){
    
    $event_ID = Input::get('id','get');
    Redirect::to(DNADMIN.'/exportplatinum/');
}
if($url_struc['branch-sub2'] =='exportcorporate'){
    
    $event_ID = Input::get('id','get');
    Redirect::to(DNADMIN.'/exportcorporate/');
}
if($url_struc['branch-sub2'] =='exportmembers'){
    
    $event_ID = Input::get('id','get');
    Redirect::to(DNADMIN.'/exportmembers/');
}
if($url_struc['branch-sub2'] =='exportgovernmentofficial'){
    
    $event_ID = Input::get('id','get');
    Redirect::to(DNADMIN.'/exportgovernmentofficial/');
}
        ...
        case 'participant-state':
            if(
                ...
                if($participantTable->count()){
                    ...
                    if($session_user_data->groups == 'Admin' || $session_user_data->groups == 'TAS-SUPER-Admin' || $session_user_data->groups == 'TAS-Admin' || $session_user_data->groups == 'OGS-User'){
        ...
        case 'participant-editCategory':
            if(
                ...
                if($participantTable->count()){
                    ...
                    if($session_user_data->groups == 'Admin' || $session_user_data->groups == 'RG-Admin' || $session_user_data->groups == 'RG-SUPER-Admin' || $session_user_data->groups == 'TAS-Admin' || $session_user_data->groups == 'TAS-SUPER-Admin'){
        ...
        case 'participant-editSessions':
            if(
                ...
                if($participantTable->count()){
                    ...
                    if($session_user_data->groups == 'Admin' || $session_user_data->groups == 'RG-Admin' || $session_user_data->groups == 'RG-SUPER-Admin' || $session_user_data->groups == 'TAS-SUPER-Admin' || $session_user_data->groups == 'TAS-Admin'){
