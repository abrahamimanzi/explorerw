...
class RequestInvitationController  
{
    public static function add($form='Admin'){
        ...
        if($validation->passed()){
            ...
            $accommadationTable = new \RequestInvitation();
            ...
            if($diagnoArray[0] == 'NO_ERRORS'){
                ...
                try{
                    ...
                    $accommadationTable->selectQuery("SELECT* FROM `events_request_invitation` WHERE `email`=? ORDER BY `ID` DESC LIMIT 1",array($email));
                    ...
                    if($accommadationTable->count() && $accommadationTable->first()->email == $email){
                        ...
                        $subject= 'Invitation request for Transform Africa Summit ';

                        $messageText_0= 'Dear <b>'.$accommadation_data->firstname.' '.$accommadation_data->lastname.'</b>,';

                        $messageText_1= 'We have received your enquiry for invitation to attend TAS2018.';
                                ...
                                <div style="padding: 10px; margin-left: 10px margin-right: 10px">
                                    ...
                                    <section>
                                        ...
                                        <p style="font-size: 13px;">
                                            ...
                                            <b>Twitter / Facebook / Youtube:</b> RealSmartAfrica <br>
                        ...
                        $messageText_1= 'We have a new invitation request for the '.$accommadation_data->hotel.': Transform Africa Summit. Below are the applicants details.';
                        ...
                        $contactDetails['from_names'] = 'Transform Africa Summit Team';
                        $contactDetails['to_email'] = 'enquiries@smartafrica.org, invitations@smartafrica.org';
                        // $contactDetails2['to_email'] = 'kadibra2@gmail.com';

                        $contactDetails['attach'] = false;

                        $email_status = Functions::smartMailer($contactDetails,$subject,$message_body,$message_alt);
                        $contactDetails['to_email'] = 'kadibra2@gmail.com, abrahamahoshakiye@gmail.com';
                        $email_status = Functions::smartMailer($contactDetails,$subject,$message_body,$message_alt);
                        ...
                        Redirect::to(DN.'/success/invitation');
