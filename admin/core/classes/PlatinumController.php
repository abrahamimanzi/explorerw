...
{   
    public static function add($form='Admin'){
        ...
        if ($category=='Silver' OR $category=='silver' OR $category=='Individual-Silver') {
            ...
            $pass_type='Platinum';
        }elseif($category=='Ms-Geek-Silver-Discounted'){
            $category='Ms-Geek-Silver-Discounted';
            $pass_type='Silver';
        }elseif($category=='Ms-Geek-Gold-Discounted'){
            $category='Ms-Geek-Gold-Discounted';
            $pass_type='Gold';
        }elseif($category=='Ms-Geek-Platinum-Discounted'){
            $category='Ms-Geek-Platinum-Discounted';
            $pass_type='Platinum';
        }elseif($category=='Ms-Geek-Silver-Complimentary'){
            $category='Ms-Geek-Silver-Complimentary';
            $pass_type='Silver';
        }elseif($category=='Ms-Geek-Gold-Complimentary'){
            $category='Ms-Geek-Gold-Complimentary';
            $pass_type='Gold';
        }elseif($category=='Ms-Geek-Platinum-Complimentary'){
            ...
            $pass_type='Platinum';
        }elseif($category=='Panelist-Platinum-Complimentary'){
            $category='Panelist-Platinum-Complimentary';
            $pass_type='Platinum';
        }elseif($category=='Panelist-Gold-Complimentary'){
            $category='Panelist-Gold-Complimentary';
            $pass_type='Gold';
        }elseif($category=='Panelist-Silver-Complimentary'){
            $category='Panelist-Silver-Complimentary';
            $pass_type='Silver';
        }elseif($category=='Development-Partners-Platinum-Complimentary'){
            $category='Development-Partners-Platinum-Complimentary';
            $pass_type='Platinum';
        }elseif($category=='Development-Partners-Gold-Complimentary'){
            $category='Development-Partners-Gold-Complimentary';
            $pass_type='Gold';
        }elseif($category=='Development-Partners-Silver-Complimentary'){
            $category='Development-Partners-Silver-Complimentary';
            $pass_type='Silver';
        }elseif($category=='Private-Sector-Federation-Platinum-Complimentary'){
            $category='Private-Sector-Federation-Platinum-Complimentary';
            $pass_type='Platinum';
        }elseif($category=='Private-Sector-Federation-Gold-Complimentary'){
            $category='Private-Sector-Federation-Gold-Complimentary';
            $pass_type='Gold';
        }elseif($category=='Private-Sector-Federation-Silver-Complimentary'){
            $category='Private-Sector-Federation-Silver-Complimentary';
            $pass_type='Silver';
        }elseif($category=='Diplomatic-Mission-Platinum-Complimentary'){
            $category='Diplomatic-Mission-Platinum-Complimentary';
            $pass_type='Platinum';
        }elseif($category=='Diplomatic-Mission-Gold-Complimentary'){
            $category='Diplomatic-Mission-Gold-Complimentary';
            $pass_type='Gold';
        }elseif($category=='Diplomatic-Mission-Silver-Complimentary'){
            $category='Diplomatic-Mission-Silver-Complimentary';
            $pass_type='Silver';
        }elseif($category=='Bbcom-silver-complimentary'){
            $category='Bbcom-silver-complimentary';
            $pass_type='Silver';
        }elseif($category=='Bbcom-gold-complimentary'){
            $category='Bbcom-gold-complimentary';
            $pass_type='Gold';
        }elseif($category=='Bbcom-platinum-complimentary'){
                    ...
                    if($participantTable->count() && $participantTable->first()->email == $email){
                        ...
                        switch($category){
                            ...
                            case 'Diplomatic-Mission-Silver-Complimentary':
                                $categ_code = "DMSIL";
                                break;
                            case 'Bbcom-silver-complimentary':
                                $categ_code = "BSC";
                                break;
                            case 'Bbcom-gold-complimentary':
                                $categ_code = "BGC";
                                break;
                            case 'Bbcom-platinum-complimentary':
                                $categ_code = "BPC";
                                break;
                        }
                        ...
                        if ($categ_code == "BSC" OR $categ_code == "BGC" OR $categ_code == "BPC") {
                            $subject= 'Your complimentary registration to both the Broadband Commission Annual
                            Meeting and Transform Africa Summit 2018.';

                            $messageText_0= 'Dear <b>'.$participant_data->firstname.' '.$participant_data->lastname.' '.$participant_data->othername.'</b>,';

                            $messageText_1= 'Thank you for registering your details for the Broadband Commission 
                            Annual Meeting and Transform Africa Summit 2018.';

                            $messageText_2= 'The badge issued will give you access to both events. You will be 
                            advised on the venue for badge collection. Please ensure you have your ID.';

                            $messageText_3= 'Your registration ID will be shared shortly.';
                                    ...
                                    <div style="padding: 10px; margin-left: 10px margin-right: 10px">
                                        ...
                                        <section>
                                            ...
                                            <p style="font-size: 13px;">
                                                <b>Key dates:</b><br>
                                                <ul>
                                                    <li>Broadband Commission Workshops: 6 May 2018 (By invitation from the Broadband Commission)</li>
                                                    <li>Broadband Commission meeting: 7 May 2018 (By invitation from the Broadband Commission)</li>
                                                    <li>Transform Africa Economic Forum: 7 May 2018</li>
                                                    <li>Transform Africa Summit: 8 – 9 May 2018</li>
                                                    <li>Transform Africa Summit Golf Tournament: 10 May 2018</li>
                                                </ul>
                                            </p>
                                            <br>
                                            <p style="font-size: 13px;">
                                                For accommodation, transport or any other travel queries, 
                                                please write to patricia.benoit-guyot@itu.int, your contact 
                                                point at the International Telecommunication Union (ITU)
                                            </p>
                                            <br>
                                            <p style="font-size: 13px;">
                            ...
                            if($subscateg_data->plan!='Free'){
                                if ($payment_method == 'Debit/Credit Card') {
                                    ...
                                    $messageText_3='<a href="'.DN.'/payment/'.$participant_code.'">Click here</a> to download payment details';

                                    $messageText_4= 'Please ensure that you follow the instructions to ensure your payment is tracked and credited to your registration.';

                                    $messageText_5= 'You will be notified when we receive your payment via bank transfer or direct deposit.';
                                }
