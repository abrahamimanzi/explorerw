...
//                            $reference_number = $code_string_0.'-'.Dates::get('Ymdhis');
                        ...
                        if($_invitation_source){
                            ...
                            $subject= 'Media Pass application for Transform Africa Summit';

                            $messageText_0= 'Dear <b>'.$participant_data->firstname.' '.$participant_data->lastname.' '.$participant_data->othername.'</b>,';

                            $messageText_1= 'Thank you for applying for a media pass to the Transform Africa Summit.';
                            ...
                            // $messageText_2= 'We will revert within shortly on its status.';
                                ...
                                <body>
                                    <div style="padding: 10px; margin-left: 10px margin-right: 10px">
                                        ...
                                        <section>
                                            ...
                                            <p style="font-size: 13px;">
                                                <b>Confirmation:</b><br>
                                                You will receive your confirmation to attend the summit within a 
                                                few days at which point you may proceed to book your accommodation 
                                            ...
                                            <p style="font-size: 13px;">
                                                ...
                                                You will be advised on the venue for badge collection. 
                                                Ensure you bring the identification document you used in 
                                                your registration process as well as your press card.  
                                                Please note that your badge will only be issued once you have 
                                                received your confirmation to attend the summit.
                                            ...
                                            <p style="font-size: 13px;">
                                                <b>Media transport:</b><br>
                                                To ease your travel around Kigali, international media will enjoy a 
                                                shuttle service from the airport to the official Transform Africa 
                                                hotel booked through the website and back.
                                            ...
                                            <br>
                                            <p style="font-size: 13px;">
                                                If you have received this email in error, please forward it to media@smartafrica.org.
                                            </p>
                                            <br>
                                        </section>
