                    ...
                    <body>
                        <div style="padding: 10px; margin-left: 10px margin-right: 10px">
                            ...
                            <section>
                                ...
                                <p style="font-size: 13px;">
                                    '.$messageText_4.'<br>
                                    <a href="'.$invite_url.'">Click here to register</a><br>
                                </p>
                                <p style="font-size: 13px;">
                                    '.$messageText_5.'
                                </p>
    ...
    public static function reminderInvite(){
        ...
        if($validation->passed()){
            ...
            if($diagnoArray[0] == 'NO_ERRORS'){
                ...
                $messageText_1= 'You were invited to register for the Transform Africa Summit 2018 in Kigali from the 8 – 10 May 2018 by: ';
                ...
                $messageText_7= '<b>Deadline for registration:</b><br>
                    <ul>
                        ...
                        <li>Local delegates i.e. residents of Rwanda: <b>24 April 2018</b></li>
                    </ul>';

                $messageText_8= '<b>Key dates:</b><br>
                    <ul>
                        <li>Transform Africa Economic Forum: 7 May 2018 (Platinum delegates)</li>
                        <li>Transform Africa Summit: 8 – 9 May 2018 (Silver, Gold, Platinum delegates)</li>
                        <li>Transform Africa Summit Golf Tournament: 10 May 2018 (Gold & Platinum delegates)</li>
                    </ul>';
