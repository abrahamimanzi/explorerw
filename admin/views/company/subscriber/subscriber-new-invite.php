                ...
                <div class="box box-info">
                    ...
                    <div class="box-body" style="padding: 30px; ">
                          ...
                          <label>Send email</label>
                            <span style="color: red; font-size: 12px; display: block"> <?php if($form->ERRORS){ echo @$form->ERRORS_SCRIPT['send_email'][0];}?></span>
                            <select name="subscriber-send_email" class="form-control">
