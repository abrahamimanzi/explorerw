              ...
              <li class="dropdown notifications-menu">
                ...
                <ul class="dropdown-menu dropdown-menu-right" style="height: 83px;">
                  <li>
                    ...
                    <?php if($session_user_data->groups == 'Admin' || $session_user_data->groups == 'TAS-Admin' || $session_user_data->groups == "TAS-SUPER-Admin" || $session_user_data->groups == "RG-Admin" || $session_user_data->groups == "RG-SUPER-Admin"){?>
                                    ...
                                    foreach($subscriberTable->data() as $subscriber_data){
                                      ...
                                      <tr <?php if($subscriber_data->state =='Blocked'){?>style="color: #aaa"<?php }?>>
                                        ...
                                        <td>
                                         ...
                                         <?php if($session_user_data->groups == "Admin" || $session_user_data->groups == "TAS-Admin" || $session_user_data->groups == "TAS-SUPER-Admin" || $session_user_data->groups == "RG-SUPER-Admin" || $session_user_data->groups == "RG-Admin"){?>
                                            ...
                                            <div id="subscriber-menu-content-<?=$subscriber_data->ID?>" class="hidden">
                                                <form method="post">
                                                    ...
                                                    <ul class="popover-menu-list">
                                                      ...
                                                      <li><a class="menu popover-close" data-popoverid=".participant-menu-popover-<?=$participant_data->ID?>" data-toggle="modal" data-target="#myEditModal_<?=$subscriber_data->ID?>"><i class="fa fa-pencil icon"></i> Get link</a></li>
                                                      
                                                        <div class="modal fade" id="myEditModal_<?=$subscriber_data->ID?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                          <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <form method="post" enctype="multipart/form-data">
                                                                    <div class="modal-header">
                                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                        <h4 class="modal-title" id="myModalLabel">Register Link</h4>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                      <!-- <p><?=DN?>/register/<?=$subscriber_data->token?>/<?=$subscriber_data->shared_string?></p> -->
                                                                      <div class="form-group">
                                                                        <label for="category">Copy Link</label>
                                                                        <textarea rows="3" class="form-control bordered"><?=DN?>/register/<?=$subscriber_data->token?>/<?=$subscriber_data->shared_string?></textarea>
                                                                      </div>
                                                                    </div>
