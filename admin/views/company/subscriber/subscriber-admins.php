                                                ...
                                                <ul class="popover-menu-list">
                                                  <form method="post">
                                                      ...
                                                      <input type="hidden" name="subscriber-id" value="<?=$subscriber_data->ID?>">
						                                          <?php if($session_user_data->groups == "Admin" || $session_user_data->groups == "TAS-SUPER-Admin" || $session_user_data->groups == "RG-SUPER-Admin" || $session_user_data->groups == "RG-Admin"){?>
                                                          <?php if ($subscriber_data->type == 'Group') {?>
