	  ...
	  <div class="row">
          <div class="col-sm-8">
              <form method="post">
                ...
                <?php }?>
                <?php if($session_user_data->groups == "Admin" || $session_user_ID == $user_ID || $session_user_data->groups == 'RG-SUPER-Admin' || $user_data->groups == 'TAS-Admin'){?>
                <option value="TAS-Admin" <?php if($user_data->groups == 'TAS-Admin'){ echo 'selected';}?>>TAS-Admin</option>
                <?php }?>
                ...
                <?php }?>
                <?php if($session_user_data->groups == "Admin" || $session_user_ID == $user_ID || $session_user_data->groups == 'RG-SUPER-Admin' || $user_data->groups == 'TAS-SUPER-Admin'){?>
                <option value="TAS-SUPER-Admin" <?php if($user_data->groups == 'TAS-SUPER-Admin'){ echo 'selected';}?>>TAS-SUPER-Admin</option>
