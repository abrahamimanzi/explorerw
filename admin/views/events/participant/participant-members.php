              ...
              <div>
                ...
                <div class="box">
                    ...
                    <?php
                        ...
                        $participantTable->selectQuery("SELECT * FROM `events_member` WHERE `type`='Smart Africa Members' ",$sql_val_array);
                        $participantApprovalNumber = $participantTable ->count();
                    ?>
                      <h3 class="box-title">Smart Africa Members <span style='color:#01aef0'><?=$participantApprovalNumber?></span></h3>
                          ...
                          <tbody>
                            ...
                            $seconds = \Config::get('time/seconds');
                              $participantTable = new Member();
                                ...
                                $participantTable->selectQuery("SELECT* FROM `events_member` WHERE `type`='Smart Africa Members' AND `pass_type`!='No pass' AND `state`!=? AND `event_ID`=? $search_sql ORDER BY {$_SESSION['participant_sort']}",$sql_val_array);
                            ...
                            if(Input::checkInput('request','post',1)){
                                ...
                                $participantTable->selectQuery("SELECT * FROM `events_member` WHERE `type`='Smart Africa Members' $search_sql ORDER BY {$_SESSION['participant_sort']} LIMIT {$offsetNumber},{$rowsLimit}",$sql_val_array);
                    ...
                    <div class="box-footer clearfix">
                        ...
                        <?php  
                            ...
                            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-list-exportmembers" class="btn btn-sm btn-primary btn-flat pull-right">Export</a>
                        <?php } ?>
                    </div>
                    <!-- /.box-footer -->
                  </div>
