                                                ...
                                                <form method="post">
                                                    ...
                                                    <ul class="popover-menu-list">
                                                        ...
                                                        if(($session_user_data->groups == 'Admin' || $session_user_data->groups == 'TAS-Admin' || $session_user_data->groups == 'TAS-SUPER-Admin' || $session_user_data->groups == 'OGS-User') && ($participant_data->pass_type == 'Silver' ||$participant_data->pass_type == 'Gold' ||$participant_data->pass_type == 'Platinum' || $participant_data->pass_type == 'Exhibitor' || $participant_data->category=='Government' || $participant_data->category=='Delegate request' || $participant_data->category=='Government request' || $participant_data->category=='Madia request')){?>
                                                            ...
                                                            <?php if($participant_data->payment_state!='Confirmed' || ($participant_data->state!='Confirmed' AND $participant_data->category=='Government' AND $participant_data->payment_state!='Confirmed') AND ($session_user_data->groups != 'TAS-Admin')){?>
                                                            <li> 
                                                                <button class="menu" name="payment-confirm" type="submit"><i class="fa fa-check-circle icon"></i> Confirm Payment1 </button>
                                                            </li>
                                                            <?php }?>

                                                            <?php if($participant_data->payment_state!='Refunded' && $participant_data->payment_state=='Confirmed'){?>
                                                            <li> 
                                                        ...
                                                        <?php
                                                        if(($session_user_data->groups == 'Admin' || $session_user_data->groups == 'TAS-Admin' || $session_user_data->groups == 'TAS-SUPER-Admin') && ($participant_data->pass_type == 'Silver' ||$participant_data->pass_type == 'Gold' ||$participant_data->pass_type == 'Platinum' || $participant_data->pass_type == 'Exhibitor' || $participant_data->category=='Government')){?>
                                                            <?php if($participant_data->payment_state=='Confirmed'){?>
                                                            <li><a class="menu" href="<?=DN?>/receipt-single/<?=$participant_data->token?>" target="invoice_tab"><i class="fa fa-print icon"></i> Print Invoice</a></li>
                                                            <?php }?>
                                                            ...
                                                            <!-- <li> 
                                                                <button class="menu" name="payment-confirm" type="submit"><i class="fa fa-check-circle icon"></i> Confirm Payment2</button>
                                                            </li> -->
                                                            <?php }?>
