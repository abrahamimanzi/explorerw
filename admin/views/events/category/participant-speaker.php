                                            ...
                                            <div id="participant-menu-content-<?=$participant_data->ID?>" class="hidden">
                                                <form method="post">
                                                    ...
                                                    <ul class="popover-menu-list">
                                                        ...
                                                        <?php  
                                                        if($session_user_data->groups == 'Admin' || $session_user_data->groups == 'RG-Admin'){?>
                                                        ...
                                                        <?php
                                                        if(($session_user_data->groups == 'Admin' || $session_user_data->groups == 'YCA-Admin' || $session_user_data->groups == 'YCA-SUPER-Admin') && ($participant_data->category == 'Delegate' || $participant_data->category == 'Exhibitor')){?>
