...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box bg-platinum">
                    
            <?php

                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE  (`pass_type`='Platinum') ");
            ...
            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-platinum" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-gold">
            ...
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE  (`pass_type`='Gold') ");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>
            ...
            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-gold" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-silver">
            ...
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE  (`pass_type`='Silver') ");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>
            ...
            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-silver" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <!-- ./col -->
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-warning">
            ...
            <?php
                ...
                // YCA
                // $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `payment_state`='Confirmed' AND `state`!='Confirmed'");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>
            ...
            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-forapproval" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-orange">
            ...
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE  (`pass_type`='Silver' || `pass_type`='Gold' || `pass_type`='Platinum' || `pass_type`='Delegate') ");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-msgeek">
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `pass_type`='media' || `category`='Media' || `category`='Media request' || `category`='Media invited'");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-msgeek">
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `pass_type`='Delegate-liasion' || `pass_type`='Delegate-Liaison' || `pass_type`='Delegate Liaison' || `category`='Delegate-Liaison' || `category`='Delegate-liasion'");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>

              <p>Delegate liaison</p>
            </div>
            <div class="icon">
              <i class="fa fa-ban"></i>
            </div>
            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-liaison" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
          <!-- small box -->
        </div>
        <!-- ./col -->
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-msgeek">
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `pass_type`='Armed-security' || `category`='Armed-security' || `pass_type`='Armed security' || `category`='Armed-security'");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>
            ...
            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-armed" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
          <!-- small box -->
        </div>
        <!-- ./col -->
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-msgeek">
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `pass_type`='Security'");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>
            ...
            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-security" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
          <!-- small box -->
        </div>
        <!-- ./col -->
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-msgeek">
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `pass_type`='Protocol' || `category`='Protocol'");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>
            ...
            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-protocol" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
          <!-- small box -->
        </div>
        <!-- ./col -->
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-msgeek">
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `pass_type`='Medical'");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>
            ...
            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-medical" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
          <!-- small box -->
        </div>
        <!-- ./col -->
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-msgeek">
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `pass_type`='Catering'");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>
            ...
            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-catering" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
          <!-- small box -->
        </div>
        <!-- ./col -->
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-msgeek">
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `pass_type`='Production-technician'");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>
            ...
            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-technician" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
          <!-- small box -->
        </div>
        <!-- ./col -->
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-msgeek">
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `pass_type`='Contractor' || `category`='Contractor'");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>
            ...
            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-contractor" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
          <!-- small box -->
        </div>
        <!-- ./col -->
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-msgeek">
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `pass_type`='Moderator'");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>
            ...
            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-moderator" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
          <!-- small box -->
        </div>
        <!-- ./col -->
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-msgeek">
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `pass_type`='COMS'");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>
            ...
            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-coms" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
          <!-- small box -->
        </div>
        <!-- ./col -->
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-msgeek">
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `category`='Government' || `category`='Government request' || `category`='Government invited' || `pass_type`='Government'");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-msgeek">
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `pass_type`='Speaker' || `category`='Speaker-Applicant'");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>
            ...
            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-speaker" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
          <!-- small box -->
        </div>
        <!-- ./col -->
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-msgeek">
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `pass_type`='Smart-Africa-Orgniser'");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>

              <p>Smart Africa Orgniser</p>
            </div>
            <div class="icon">
              <i class="fa fa-ban"></i>
            </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-msgeek">
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `pass_type`='Event-Management'");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-msgeek">
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `pass_type`='Usher'");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>
            ...
            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-usher" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
          <!-- small box -->
        </div>
        <!-- ./col -->
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-msgeek">
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `pass_type`='Clinician'");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>
            ...
            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-clinician" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
          <!-- small box -->
        </div>
        <!-- ./col -->
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-msgeek">
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `pass_type`='Entertainers'");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>
            ...
            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-entertainers" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
          <!-- small box -->
        </div>
        <!-- ./col -->
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-participants">
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE (`pass_type` = 'Visitor' || `pass_type` = 'Silver' || `pass_type` = 'Gold' || `pass_type` = 'Platinum' || `pass_type` = 'Speakers' || `pass_type` = 'Delegate' || `pass_type` = 'VVIP' || `pass_type` = 'VIP') AND (`pass_type`!='No pass') AND (`residence_country`!='Rwanda')");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-participants">
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE (`pass_type` = 'Visitor' || `pass_type` = 'Silver' || `pass_type` = 'Gold' || `pass_type` = 'Platinum' || `pass_type` = 'Speakers' || `pass_type` = 'Delegate' || `pass_type` = 'VVIP' || `pass_type` = 'VIP') AND `pass_type`!='No pass'");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>
        ...
        <!-- <div class="col-lg-3 col-xs-6"> 
          <div class="small-box bg-delegate">
            ...
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE  (`category`='Delegate-request' || `category`='Delegate request' || `category`='Government-request' || `category`='Government request')");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>
            ...
            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-request" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div> -->
        <!-- ./col -->
        <!-- ./col -->
        ...
        <!-- <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-exhibitor">
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE   (`category`='Delegate-invited' || `category`='Delegate invited' || `category`='Government-invited' || `category`='Government invited') ");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>
            ...
            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-invitee" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div> -->
        <!-- ./col -->
        <!-- ./col -->
        ...
        <!-- <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-visitor">
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE   (`payment_state`='Confirmed') ");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>
            ...
            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-ycaapproved" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div> -->
        <!-- ./col -->
        ...
        <!-- <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-participants">
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE (`pass_type` = 'Visitor' || `pass_type` = 'Silver' || `pass_type` = 'Gold' || `pass_type` = 'Platinum' || `pass_type` = 'Speakers' || `pass_type` = 'Delegate' || `pass_type` = 'VVIP' || `pass_type` = 'VIP') AND `residence_country`!='Rwanda' AND `pass_type`!='No pass'");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>
            ...
            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-foreignparticipants" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div> -->
        <!-- ./col -->
        ...
        <!-- <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-participants">
            ...
            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-localparticipants" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div> -->
        <!-- ./col -->
        <!-- ./col -->
        <!-- <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-visitor">
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE   (`payment_state`='Confirmed') AND `residence_country`!='Rwanda' ");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>

              <p>Foreign YCA Approved</p>
            </div>
            <div class="icon">
              <i class="fa fa-ban"></i>
            </div>
            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-foreignycaapproved" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div> -->
        <!-- ./col -->
        <!-- ./col -->
        <!-- <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-visitor">
            ...
            <div class="inner">
              ...
              <p>Local YCA Approved</p>
            </div>
            <div class="icon">
              <i class="fa fa-ban"></i>
            </div>
            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-localycaapproved" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div> -->
        <!-- ./col -->
