                                    ...
                                    switch($url_struc['branch-sub1']){
                                        ...
                                        default:
                                            if(empty($url_struc['branch-sub1'])){
                                                ...
                                                $categ_array = array('vvip','vip','delegate','delegate-liasion',
                                                    'exhibitor','speaker','visitor','media','ftg','msgeek','approved',
                                                    'forapproval','denied','pending','government','missing','noc',
                                                    'organiser','liaison','security','protocol','medical','catering',
                                                    'technician','contractor','armed','moderator','coms',
                                                    'participants','search','request','invitee','ycaapproved',
                                                    'foreignparticipants','localparticipants','foreignycaapproved',
                                                    'localycaapproved','silver','gold','platinum','corporate','members',
                                                    'governmentofficial','invitations');
                                    ...
                                    switch($url_struc['branch-sub1']){
                                        ...
                                        default:
                                            if(empty($url_struc['branch-sub1'])){
                                                ...
                                                $requested_categ = $url_struc['branch-sub1'];
                                                $categ_array = array('delegate','exhibitor','speaker','visitor','media',
                                                    'ftg','msgeek','approved','denied','pending','government',
                                                    'missing','noc','organiser','liaison','security','protocol',
                                                    'medical','catering','technician','contractor','armed',
                                                    'participants','contractor','armed','moderator','coms',
                                                    'participants','search','request','invitee','ycaapproved',
                                                    'foreignparticipants','localparticipants','foreignycaapproved',
                                                    'localycaapproved','silver','gold','platinum');
                                                if(in_array($requested_categ,$categ_array)){
                                                    include 'views/events/participant/participant-'.$requested_categ.PL;
                                                }
                                            }
