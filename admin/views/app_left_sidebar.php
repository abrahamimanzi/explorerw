...
-->
            ...
            <?php
                if($session_user_data->groups == 'Admin' || $session_user_data->groups == 'RG-Admin' || $session_user_data->groups == 'RG-SUPER-Admin'){?>
                    ...
                    <li class="<?php if($url_struc['tree']=="app" && $url_struc['trunk']=="home"){ echo 'actived';}?>">
                        <a href="<?=DNADMIN?>/app/EventApp/5/participant-silver"><i class="fa fa-circle-o icon"></i> <span>Silver</span></a>
                    </li>
                    <li class="<?php if($url_struc['tree']=="app" && $url_struc['trunk']=="home"){ echo 'actived';}?>">
                        <a href="<?=DNADMIN?>/app/EventApp/5/participant-gold"><i class="fa fa-circle-o icon"></i> <span>Gold</span></a>
                    </li>
                    <li class="<?php if($url_struc['tree']=="app" && $url_struc['trunk']=="home"){ echo 'actived';}?>">
                        <a href="<?=DNADMIN?>/app/EventApp/5/participant-platinum"><i class="fa fa-circle-o icon"></i> <span>Platinum</span></a>
                    </li>
                    <li class="<?php if($url_struc['tree']=="app" && $url_struc['trunk']=="home"){ echo 'actived';}?>">
            ...
            <li class="treeview <?php if($url_struc['tree'] == "app" && $url_struc['app-idname']=="Corporate"){ echo 'actived';}?>">
                <a href="#"><i class="fa fa-book blueapp-col"></i> <span> Invitations</span></a>
                <ul class="treeview-menu">

                    <li class="<?php if($url_struc['tree']=="app" && $url_struc['trunk']=="home"){ echo 'actived';}?>">
                        <a href="<?=DNADMIN?>/app/Corporate/5/participant-invitations"><i class="fa fa-circle-o icon"></i> <span>Invitations request</span></a>
                    </li>
                </ul>
            </li>
            <li class="treeview <?php if($url_struc['tree'] == "app" && $url_struc['app-idname']=="Corporate"){ echo 'actived';}?>">
                <a href="#"><i class="fa fa-book blueapp-col"></i> <span> Corporate</span></a>
                <ul class="treeview-menu">

                    <li class="<?php if($url_struc['tree']=="app" && $url_struc['trunk']=="home"){ echo 'actived';}?>">
                        <a href="<?=DNADMIN?>/app/Corporate/5/participant-corporate"><i class="fa fa-circle-o icon"></i> <span>Corporate request</span></a>
                    </li>
                </ul>
            </li>
            <li class="treeview <?php if($url_struc['tree'] == "app" && $url_struc['app-idname']=="Members"){ echo 'actived';}?>">
                <a href="#"><i class="fa fa-book blueapp-col"></i> <span> Smart Africa Members</span></a>
                <ul class="treeview-menu">

                    <li class="<?php if($url_struc['tree']=="app" && $url_struc['trunk']=="home"){ echo 'actived';}?>">
                        <a href="<?=DNADMIN?>/app/Members/5/participant-members"><i class="fa fa-circle-o icon"></i> <span>Smart Africa Members</span></a>
                    </li>
                </ul>
            </li>
            <li class="treeview <?php if($url_struc['tree'] == "app" && $url_struc['app-idname']=="Government"){ echo 'actived';}?>">
                <a href="#"><i class="fa fa-book blueapp-col"></i> <span> Government Official</span></a>
                <ul class="treeview-menu">

                    <li class="<?php if($url_struc['tree']=="app" && $url_struc['trunk']=="home"){ echo 'actived';}?>">
                        <a href="<?=DNADMIN?>/app/Government/5/participant-governmentofficial"><i class="fa fa-circle-o icon"></i> <span>Government Official</span></a>
                    </li>
                </ul>
            </li>
