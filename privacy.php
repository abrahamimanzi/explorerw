...
<body class="home page page-id-2">
	...
	<div id="wrapper" class="nav-top-mc"> 
        ...
        <section class="section-main white-bg" style="padding: 0;">
          <div class="container-fluid bg">
            <div class="container white-bg">
                <div class="register_layout" id="other" >
                  <div class="text-left"> 
                  	<div class="w3_tittle second two"><h3 class="agile-tittle two gal reg">Privacy Policy</h3> 
                    ...
                    <p class="text-center">Smart Africa Secretariat ("we" or "us") are committed to protecting and respecting your privacy. This privacy policy has been created in order to demonstrate our firm commitment to your privacy.
						<br>
						This policy (together with our terms of use) sets out the basis on which any personal data we collect from you, or that you provide to us, will be processed by us.</p>
					  <ol class="" style="line-height: 1.6;">
						  <li><strong>Information we may collect from you</strong><br/>
