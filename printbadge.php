...
// Instanciation of inherited class
        ...
        $pdf->Cell(0,0,$participant_data->firstname.' '.$participant_data->lastname.' '.$participant_data->othername,0,0,'C');
        

        $pdf->Image(DN.'/img/elham.jpg',195,185,-300);
        $ex1 = new QRGenerator(); 

        // $pdf->Image(($ex1->generate()),195,400,-300);
        //echo "<img src=".$ex1->generate().">";
        $pdf->Image(DN.'/img/elham.jpg',195,400,-300);
...
//             $pdf->Ln(-25);
//             $pdf->SetX(270);
//             $pdf->Cell(90,25,$participant_data->code,0,1,'L');
...
//             $pdf->Ln(-25);
//             $pdf->SetX(270);
//             $pdf->Cell(90,25,$participant_data->amount.' '.$participant_data->currency,0,1,'L');
...
//             $pdf->Ln(-25);
//             $pdf->SetX(270);
//             $pdf->Cell(90,25,'Bank of Kigali, Headquarters
// KN 4 Ave, Kigali – Rwanda',0,1,'L');
...
//             $pdf->Cell(0,0,'',1,1,'L');
        ...
        $pdf->Output('I','BADGE-'.$participant_data->code.'.pdf');
