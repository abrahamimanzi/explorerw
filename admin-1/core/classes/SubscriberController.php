            ...
            if($diagnoArray[0] == 'NO_ERRORS'){
                ...
                if($find_user){
                    ...
                    ** Kindly save this email for future reference **';
                    ...
                    These are passes that you have already been pre-assigned by the Smart Africa team on a corporate basis. These are already listed in your booking portal. Simply assign individuals & send their invites so they may complete their registration.<br><br>
                    ...
                    These are passes that you will purchase once your group members have completed registration. This list will be empty when you first log on and will populate itself as you send invites to group individuals and select their passes.
';
...
Adviser on Young Entrepreneurs, will grace the occasion.';
                ...
                */
                ...
                for your organization for the Transform Africa Summit 2018, your group booking 
                    account has been successfully created.<br><br>
                <b>Your group ID is '.$subscriber_code.'</b><br>
                <b>Deadline for registration: 30<sup>th</sup> April 2018</b><br>
                ** Kindly save this email for future reference **';

                $messageText_2= '<b>How the group booking portal works</b><br>
                1.  Use the link below (Transform Africa Summit 2018 Group Booking Portal) 
                        ...
                        <div style="padding: 10px; margin-left: 10px; margin-right: 10px">
                            ...
                            <section>
                                ...
                                <p style="font-size: 13px;">
                                    ...
                                    Use promotional code<b>TAS2017</b> to receive discounted conference rates up till 10 April 2018.
