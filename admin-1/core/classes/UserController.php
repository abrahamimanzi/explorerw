		...
		if($validation->passed()){
			...
			if($diagnoArray[0] == 'NO_ERRORS'){
                ...
                if($find_user){
                    ...
                    $subject = "Your User Account for Transform Africa Summit 2018 has been created";
                    ...
                    $messageText_1= 'Your account as a user on the Transform Africa Summit 2018 registration system has been created.';
                    ...
                    to accreditation@rg.gov.rw and call Transform Africa Team contact +250 732 105 105. Should you not 
                    ...
                    <body>
                        <div style="padding: 10px; margin-left: 10px; margin-right: 10px">
                            ...
                            <section>
                                ...
                                <p style="font-size: 13px;">
                                    <b>Become part of the Transform Africa network and stay informed</b> <br>
                                    <b>Twitter / Facebook/Instagram:</b> TransformAfricaSummit <br>
                                    <b>Connect with our official tag:</b> #TAS2018<br>
                                    <b>Youtube:</b> TransformAfricaSummit<br>
                                </p>
                                <br>
