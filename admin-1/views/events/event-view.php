...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box bg-vvip">
                    
            <?php

                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE  (`pass_type`='VVIP') ");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>
            ...
            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-vvip" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-vip">
            ...
            <?php
                ...
                $participantTable = new Participant();
                $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE  (`pass_type`='VIP') ");
                $participantApprovalNumber = $participantTable ->count();
            ?>
            <div class="inner">
              <h3><?=$participantApprovalNumber?></h3>
            ...
            <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-vip" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
