              ...
              <div>
                ...
                <div class="box">
                        ...
                        <table class="table no-margin">
                          <thead>
                            <form method="post">
                              <tr>
                                ...
                                <th style="width: 90px"><button type="submit" name="sort-payment_state">Invitation</button></th>
                          ...
                          <tbody>
                            ...
                            if(Input::checkInput('request','post',1)){
                                ...
                                // $participantTable->selectQuery("SELECT * FROM `events_participant` WHERE `added_date` >= '25-03-2018' AND `added_date` <= '29-03-2018'");
                                            ...
                                            <div id="participant-menu-content-<?=$participant_data->ID?>" class="hidden">
                                                ...
                                                <form method="post">
                                                    ...
                                                    <ul class="popover-menu-list">
                                                        ...
                                                        <?php
                                                        if(($session_user_data->groups == 'Admin' || $session_user_data->groups == 'YCA-Admin' || $session_user_data->groups == 'OGS-Admin' || $session_user_data->groups == 'YCA-SUPER-Admin') && ($participant_data->pass_type == 'Silver' ||$participant_data->pass_type == 'Gold' ||$participant_data->pass_type == 'Platinum' || $participant_data->pass_type == 'Exhibitor')){?>
                                                            <?php if($participant_data->payment_state=='Confirmed'){?>
                                                            <li><a class="menu" href="<?=DN?>/receipt-single/<?=$participant_data->token?>" target="invoice_tab"><i class="fa fa-print icon"></i> Print Invoice</a></li>
                                                            <?php }?>
                                                        ...
                                                        <?php }?>
                                                        <?php  
                                                        if($session_user_data->groups == 'Admin' || $session_user_data->groups == 'RG-Admin' || $session_user_data->groups == 'RG-SUPER-Admin' || $session_user_data->groups == 'YCA-Admin' || $session_user_data->groups == 'OGS-User' || $session_user_data->groups == 'YCA-SUPER-Admin'){?>
                                                        ...
                                                        <?php }?>
                                                        <?php  
                                                        if($session_user_data->groups == 'Admin' || $session_user_data->groups == 'RG-Admin' || $session_user_data->groups == 'RG-SUPER-Admin' || $session_user_data->groups == 'YCA-Admin' || $session_user_data->groups == 'OGS-User' || $session_user_data->groups == 'YCA-SUPER-Admin' || $session_user_data->groups == 'Sessions-Admin'){?>
                    ...
                    <div class="box-footer clearfix">
                        ...
                        <?php  
                            if($session_user_data->groups == 'Admin' || $session_user_data->groups == 'RG-Admin' || $session_user_data->groups == 'RG-SUPER-Admin' || $session_user_data->groups == 'OGS-User' || $session_user_data->groups == 'YCA-SUPER-Admin'){?>
