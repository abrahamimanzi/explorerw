          ...
          <div class="navbar-branch-menu">
            <ul class="nav navbar-nav">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                  <li>
                    ...
                    <ul class="menu">
                      ...
                      <li>
                        <a href="<?=DNADMIN?>/app/EventApp/<?=$event_ID?>/participant-government">
                            <i class="fa fa-bars text-blue"></i>Government
                        </a>
                      </li>
                      <!-- <li>
              ...
              <li class="dropdown notifications-menu">
                ...
                <?php }?>
                <?php  if($session_user_data->groups == 'Admin' || $session_user_data->groups == 'YCA-Admin' || $session_user_data->groups == 'YCA-SUPER-Admin' || $session_user_data->groups == 'OGS-User'){?>
              <li class="dropdown notifications-menu">
                <!-- Menu toggle button -->
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
