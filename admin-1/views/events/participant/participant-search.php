...
<section class="content">
 ...
 <!-- Small boxes (Stat box) -->
	  <div class="row">
        ...
        <div class="participant_details">
            ...
            <div class="col-xs-6">
              <div>
                ...
                <?php }?>
                <?php //if($participant_data->photo){?>
                    <img src="<?=DNADMIN.'/data_user/participants/'.$participant_data->code.'.jpg'?>" class="img " style="width: 100px; padding-bottom: 10px">
                <?php //}?>
              </div>
            </div>
            </div>
        ...
        <?php }?>
        <?php $foredit='editw'; if($foredit==='edit'){?>
        <div class="participant_details">
            <div class="participant_details-i">
                                            ...
                                            <div id="participant-menu-content-<?=$participant_data->ID?>" class="hidden">
                                                <form method="post">
                                                    ...
                                                    <ul class="popover-menu-list">
                                                        ...
                                                        <?php
                                                        if(($session_user_data->groups == 'Admin' || $session_user_data->groups == 'YCA-Admin' || $session_user_data->groups == 'YCA-SUPER-Admin' || $session_user_data->groups == 'OGS-User') && ($participant_data->category == 'Silver' ||$participant_data->category == 'Gold' ||$participant_data->category == 'Platinum' || $participant_data->category == 'Exhibitor')){?>
                                                            <?php if($participant_data->payment_state=='Confirmed'){?>
                                                            <li><a class="menu" href="<?=DN?>/receipt-single/<?=$participant_data->token?>" target="invoice_tab"><i class="fa fa-print icon"></i> Print Invoice</a></li>
                                                            <?php }?>
