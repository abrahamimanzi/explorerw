                                            ...
                                            <div id="participant-menu-content-<?=$participant_data->ID?>" class="hidden">
                                                ...
                                                <form method="post">
                                                    ...
                                                    <ul class="popover-menu-list">
                                                        ...
                                                        <?php
                                                        if(($session_user_data->groups == 'Admin' || $session_user_data->groups == 'YCA-Admin' || $session_user_data->groups == 'YCA-SUPER-Admin' || $session_user_data->groups == 'OGS-User') && ($participant_data->pass_type == 'Silver' ||$participant_data->pass_type == 'Gold' || $participant_data->pass_type == 'Platinum' || $participant_data->category == 'Exhibitor')){?>
                                                            <?php if($participant_data->payment_state=='Confirmed'){?>
                                                            <li><a class="menu" href="<?=DN?>/receipt-single/<?=$participant_data->token?>" target="invoice_tab"><i class="fa fa-print icon"></i> Print Invoice</a></li>
                                                            <?php }?>
