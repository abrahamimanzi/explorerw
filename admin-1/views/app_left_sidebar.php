<!-- sidebar: style can be found in sidebar.less -->
	<section class="sidebar">
		...
		<ul class="sidebar-menu">
            ...
            <li class=""><a href="<?=DNADMIN?>/app/EventApp/5"><i class="fa fa-laptop"></i> <span>TAS 2018</span></a></li>
...
-->
            ...
            <?php
                if($session_user_data->groups == 'Admin' || $session_user_data->groups == 'YCA-Admin' || $session_user_data->groups == 'YCA-SUPER-Admin' || $session_user_data->groups == 'OGS-User' || $session_user_data->groups == 'RG-Admin' || $session_user_data->groups == 'RG-SUPER-Admin'){?>
            ...
            <li class="treeview <?php if($url_struc['tree'] == "company" && $url_struc['trunk']=="subscriber"){ echo 'actived';}?>">
                <a href="#"><i class="fa fa-user blueapp-col"></i> <span>Search</span></a>
                <ul class="treeview-menu">
                    <li class="<?php if($url_struc['trunk']=="subscriber" && $url_struc['branch']=="list"){ echo 'actived';}?>">
                        <a href="<?=DNADMIN?>/app/EventApp/5/participant-search"><i class="fa fa-circle-o icon"></i> <span>Search</span></a></li>
                </ul>
            </li>
            <?php } ?>
