	  ...
	  <div class="row">
          <div class="col-sm-8">
              <form method="post">
                ...
                <?php }?>
								<?php if($session_user_data->groups == "Admin" || $session_user_ID == $user_ID || $session_user_data->groups == 'RG-SUPER-Admin' || $user_data->groups == 'Cube-Admin'){?>
                <option value="Cube-Admin" <?php if($user_data->groups == 'Cube-Admin'){ echo 'selected';}?>>Cube-Admin</option>
                <?php }?>
                ...
                <?php }?>
                <?php if($session_user_data->groups == "Admin" || $session_user_ID == $user_ID || $session_user_data->groups == 'RG-SUPER-Admin' || $user_data->groups == 'YCA-Admin'){?>
                <option value="YCA-Admin" <?php if($user_data->groups == 'YCA-Admin'){ echo 'selected';}?>>YCA-Admin</option>
                <?php }?>
                ...
                <?php }?>
                <?php if($session_user_data->groups == "Admin" || $session_user_ID == $user_ID || $session_user_data->groups == 'RG-SUPER-Admin' || $user_data->groups == 'YCA-SUPER-Admin'){?>
                <option value="YCA-SUPER-Admin" <?php if($user_data->groups == 'YCA-SUPER-Admin'){ echo 'selected';}?>>YCA-SUPER-Admin</option>
